...
export const BOOKS: Book[] = [
  { id: 24264, title: '红楼梦', author: '曹雪芹', tag: '古典', spine: 0x6e3a3a, zh: true },
  { id: 23950, title: '三国志演义', author: '罗贯中', tag: '古典', spine: 0x7a4a2a, zh: true },
  { id: 23962, title: '西游记', author: '吴承恩', tag: '古典', spine: 0x5a6e3a, zh: true },
  { id: 23863, title: '水浒传', author: '施耐庵', tag: '古典', spine: 0x3a5a6e, zh: true },
  { id: 132, title: '孙子兵法', author: '孙子', tag: 'STRATEGY', spine: 0x8a2a2a, zh: true },
  ...
  { id: 1184, title: 'MONTE CRISTO', author: 'Dumas', tag: '复仇', spine: 0x6e5a2a, zh: false },
  { id: 2701, title: 'MOBY DICK', author: 'Melville', tag: '执念', spine: 0x26364a, zh: false },
  { id: 1342, title: 'PRIDE & PREJUDICE', author: 'Austen', tag: '世情', spine: 0x6e4a5a, zh: false },
  { id: 996, title: 'DON QUIXOTE', author: 'Cervantes', tag: '史诗', spine: 0x7a6a3a, zh: false },
  { id: 1727, title: 'THE ODYSSEY', author: 'Homer', tag: '史诗', spine: 0x4a5a3a, zh: false },
  { id: 2680, title: 'MEDITATIONS', author: 'Aurelius', tag: '哲学', spine: 0x55502f, zh: false },
  { id: 11, title: 'ALICE IN WONDERLAND', author: 'Carroll', tag: '奇想', spine: 0x4a5a7a, zh: false },
  { id: 74, title: 'TOM SAWYER', author: 'Twain', tag: '冒险', spine: 0x7a5a3a, zh: false },
  { id: 76, title: 'HUCKLEBERRY FINN', author: 'Twain', tag: '冒险', spine: 0x6a4a2e, zh: false },
  ...
  { id: 120, title: 'TREASURE ISLAND', author: 'Stevenson', tag: '冒险', spine: 0x2e5a4a, zh: false },
  ...
  { id: 1497, title: 'THE REPUBLIC', author: 'Plato', tag: '哲学', spine: 0x4a4a36, zh: false },
  { id: 1998, title: 'ZARATHUSTRA', author: 'Nietzsche', tag: '哲学', spine: 0x2e2e3a, zh: false },
  { id: 2600, title: 'WAR AND PEACE', author: 'Tolstoy', tag: '史诗', spine: 0x4e3e2e, zh: false },
  { id: 135, title: 'LES MISÉRABLES', author: 'Hugo', tag: '史诗', spine: 0x36324a, zh: false },
  ...
  { id: 4300, title: 'ULYSSES', author: 'Joyce', tag: '现代', spine: 0x2a3a4a, zh: false },
  { id: 100, title: 'SHAKESPEARE 全集', author: 'Shakespeare', tag: '史诗', spine: 0x5e4a1e, zh: false },
  { id: 1399, title: 'ANNA KARENINA', author: 'Tolstoy', tag: '世情', spine: 0x6a3a4a, zh: false },
  { id: 844, title: 'BEING EARNEST', author: 'Wilde', tag: '喜剧', spine: 0x4a6a5a, zh: false },
  { id: 2542, title: "A DOLL'S HOUSE", author: 'Ibsen', tag: '戏剧', spine: 0x5a5a6e, zh: false },
  { id: 2148, title: 'POE: WORKS VOL.2', author: 'Poe', tag: 'GOTHIC', spine: 0x26262e, zh: false },
  { id: 3600, title: 'MONTAIGNE ESSAYS', author: 'Montaigne', tag: '哲学', spine: 0x4e4636, zh: false },
];
