...
export async function migrateMarket(pool){
 ...
 `CREATE TABLE IF NOT EXISTS merchant_avatars (user_id CHAR(36) PRIMARY KEY, media_id CHAR(36) NOT NULL, FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE, FOREIGN KEY(media_id) REFERENCES media(id)) ENGINE=InnoDB`,
